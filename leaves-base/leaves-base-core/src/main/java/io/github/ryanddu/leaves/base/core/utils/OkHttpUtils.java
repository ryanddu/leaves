...
public class OkHttpUtils {
	...
	static {
		...
		DEFAULT_CLIENT = (new OkHttpClient.Builder()).sslSocketFactory(sslSocketFactory(), x509TrustManager())
	...
	public static class HttpClient {
		...
		public CallWrapper postFile(String url, InputStream in, String fileName, Map<String, Object> bodyParams,
			...
			OkHttpUtils.log.debug("POST_FILE [{}], fileName:[{}], params:[{}], headers:[{}]",
					new Object[] { url, fileName, bodyParams, headers });
		...
		public CallWrapper post(String url, String body, MediaType mediaType, Map<String, Object> headers) {
			OkHttpUtils.log.debug("POST_[{}] [{}], body:[{}], headers:[{}]",
					new Object[] { mediaType, url, body, headers });
		...
		private RequestBody setFileRequestBody(InputStream in, String fileName, Map<String, Object> bodyParams)
				throws IOException {
