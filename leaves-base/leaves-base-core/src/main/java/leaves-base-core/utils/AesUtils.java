...
public class AesUtils {
    ...
    public static void main(String[] args) {
        // 对称加密 密文
        /*String input = "1629431243245&endTime=1660967243244";
        // DES加密算法，key的大小必须是8个字节
        String desKey = "12345678";
        // AES加密算法，key的大小必须是16个字节
        String aesKey = "1234567812345678";
        String encryptDes = encryptBySymmetry(input, desKey, AesUtils.DES, true);
        System.out.println("DES加密:" + encryptDes);
        String des = decryptBySymmetry(encryptDes, desKey, AesUtils.DES, true);
        ...
        String aes = decryptBySymmetry(encryptAes, aesKey, AesUtils.AES);
        System.out.println("AES解密:" + aes);
        String token = "cwr1dcJtAOLYYZih30Jp3o/YpSCQo=";
