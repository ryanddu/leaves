...
public class DateUtils {
	...
	/**
	 * 获取某天中剩余的时间（秒数） currentDate:new Date
	 */
	...
	/**
	 * 计算两个时间点相差的秒数，分钟数，小时数，天数，星期数，月数，年数等。 例如：2008-4-11 10:26:00 和 2008-4-12 0:0:0
	 * 相差1天，相差13小时，相差14*60-26分钟。
	...
	/**
	 * 获取该date的分钟，若date为空，则获取当前时间的分钟,比如传入的date是2007-12-26 10:33:21, 则返回的是2007-12-26
	 * 10:33:00
	 * @param date
	 * @return
	 */
	...
	/**
	 * 获取该date的小时，若date为空，则获取当前时间的小时,比如传入的date是2007-12-26 10:33:21, 则返回的是2007-12-26
	 * 10:00:00
	 * @param date
	 * @return
	 */
	 ...
	 * @param strDate2
	 * @param format
	 * @return strDate1 > strDate2:return 1 strDate1 = strDate2:return 0 strDate1 <
	 * strDate1:return -1
	 */
	...
	/**
	 * 检查是否是日期，并且不能大于当前日期 主要是用来验证出生日期的，但也可以用在其它的地方
	 * @return boolean 返回类型
	 * @throws
	 * @author james
