...
public final class ValidatorUtils {
     ...
     * 至少包含大写、小写、数字、下划线 2项
     */
    public static final String REGEX_USERNAME = "^(?![0-9]+$)(?![a-zA-Z]+$)[0-9A-Za-z_]{6,255}$";

    public static final Pattern PATTERN_USERNAME = Pattern.compile(REGEX_USERNAME);

    //至少包含大写、小写、数字、特殊字符 3项
    //public static final String REGEX_PASSWORD = "(?=.*([a-zA-Z].*))(?=.*[0-9].*)(?=.*[-*/+.~!@#$%^&*()_].*)[a-zA-Z0-9-*/+.~!@#$%^&*()_]{6,20}$";

    /**
     * 正则表达式:验证密码
     * 支持输入字母（区分大小写）,数字，字符，特殊字符3种类型，至少需包含两种类型
     */
    public static final String REGEX_PASSWORD = "^(?![a-zA-Z]+$)(?![0-9]+$)(?![-*/+.~!@#$%^&*()_]+$)[a-zA-Z0-9-*/+.~!@#$%^&*()_]{8,15}$";
