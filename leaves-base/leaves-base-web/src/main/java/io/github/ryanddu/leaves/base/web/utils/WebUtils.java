package io.github.ryanddu.leaves.base.web.utils;
...
public class WebUtils extends org.springframework.web.util.WebUtils {
	...
	public static String getCookieVal(String name) {
		...
		Assert.notNull(request, "req from RequestContextHolder is null");
	...
	/**
	 * 从 req 从获取 body, 并转成 javabean, contentType 必须包含'application/json'
	 * @param request HttpServletRequest
	 * @param clazz 返回结果类型
	 * @param <T> 返回结果类型
	 * @return
