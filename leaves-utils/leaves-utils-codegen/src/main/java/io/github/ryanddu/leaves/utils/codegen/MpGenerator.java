package io.github.ryanddu.leaves.utils.codegen;
	...
	private InjectionConfig getInjectionConfig() {
		...
		focList.add(new FileOutConfig(templatePath) {
			...
			public String outputFile(TableInfo tableInfo) {
				...
				return PROPS.getStr("project.path") + "/src/main/resources/mapper/"
						+ PROPS.getStr("package.moduleName", "") + "/" + tableInfo.getEntityName() + "Mapper"
						+ StringPool.DOT_XML;
			}
		});
